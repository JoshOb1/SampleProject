...
if(isset($_SESSION['standby'])) {
	...
	<div class="loading" style="margin-top: 11%;">
		...
		<div class="loading__msg"><center><b style="font-size: 22px;"><a href="#" target="_blank" style="color: black;">ANTIDDOS</a> Loading... </b><br><br>This process is automatic. Your browser will redirect to your requested content shortly<br> Your page will appear shortly.<br> DDoS protection: <a href="https://www.youtube.com/channel/UCbmD8tUeHodF-C1rsQDCe2Q?view_as=subscriber" target="_blank">enabled</a> </center></div>
	</div>
